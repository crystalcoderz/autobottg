...
`,
  selectFromMsg: `Choose one button from the popular currencies or enter the currency you want to <b>send</b> in format BTC or Bitcoin`,
  selectToMsg: 'Choose one button from the popular currencies or enter the currency you want to <b>get</b> in format BTC or Bitcoin',
  leaveMsg: 'Transaction cancelled',
  errorNameMsg: 'Currency not found.'
}
