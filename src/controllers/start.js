...
start.enter(async ctx => {
  ...
  await ctx.reply(`Please follow this <a href="${process.env.APP_HOST_PORT}/terms-of-use/${hash}?id=${uid}">link</a> to read our Terms of Use and Privacy Policy. Then, return to the bot to proceed.`, opts);
